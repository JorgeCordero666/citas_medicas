...
public class JFBuscarIDMedico extends javax.swing.JFrame {
    TableMedico tabla = new TableMedico();

    public JFBuscarIDMedico() throws SQLException {
        initComponents();
        MedicoTable();
        ...
        this.setTitle("Información médicos");
    ...
    private void initComponents() {
        ...
        jTableM.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    private void jTableMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMMouseClicked
        ...
        try {
            ...
            int Fila = jTableM.getSelectedRow();
            String codigo = jTableM.getValueAt(Fila, 0).toString();
            ps = conn.prepareStatement("SELECT idmedico, apellido, nombre, especialidad, telefono FROM medico WHERE idmedico=?");
            ps.setString(1, codigo);
            rs = ps.executeQuery();
            while (rs.next()) {
                jTFCodigo.setText(rs.getString("IDMedico"));
            }
    ...
    public void MedicoTable() throws SQLException{
        tabla.DesplegarMedico(jTableM);
        setTamaño();
    }
    
    public void Buscar(String valor) throws SQLException{
//        tabla.BuscarMedicoINF(jTableM, valor);
        setTamaño();
    }
    
    public void setTamaño(){
        jTableM.getColumnModel().getColumn(0).setPreferredWidth(10);
        jTableM.getColumnModel().getColumn(1).setPreferredWidth(30);
        jTableM.getColumnModel().getColumn(2).setPreferredWidth(30);
        jTableM.getColumnModel().getColumn(3).setPreferredWidth(100);
        jTableM.getColumnModel().getColumn(4).setPreferredWidth(35);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFBuscarIDMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFBuscarIDMedico().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(JFBuscarIDMedico.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
