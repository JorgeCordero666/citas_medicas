...
public class JFMenu extends javax.swing.JFrame {
    JFPaciente jfpaciente;
    JFCitaMedica jfcitamedica;
    JFMedico jfmedico;
    JFHorarios setHorarios;

    public JFMenu() throws SQLException {
        initComponents();
        this.setExtendedState(MAXIMIZED_BOTH);
        this.setTitle("CITAS MÉDICAS");
        jfpaciente = new JFPaciente();
        jfcitamedica = new JFCitaMedica();
        jfmedico = new JFMedico();
        setHorarios = new JFHorarios();
    ...
    private void initComponents() {
        ...
        jMenuCitaMedica = new javax.swing.JMenuItem();
        ...
        jMenu.add(jMenuPaciente);

        jMenuCitaMedica.setText("Cita médica");
        jMenuCitaMedica.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuCitaMedicaActionPerformed(evt);
            }
        });
        jMenu.add(jMenuCitaMedica);

        jMenuHorario.setText("Selección de horarios         ");
        jMenuHorario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuHorarioActionPerformed(evt);
            }
        });
        jMenu.add(jMenuHorario);
    ...
    private void jMenuCitaMedicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuCitaMedicaActionPerformed
        this.jfcitamedica.setVisible(true);
    }//GEN-LAST:event_jMenuCitaMedicaActionPerformed

    private void jMenuPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuPacienteActionPerformed
        this.jfpaciente.setVisible(true);
...
//      Salir();
    ...
    private void jMenuHorarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuHorarioActionPerformed
        this.setHorarios.setVisible(true);
    }//GEN-LAST:event_jMenuHorarioActionPerformed
    
    private void Salir(){
        String botones[] = {"  Salir  ", " Cancelar "};
        int op = JOptionPane.showOptionDialog(null, "¿SEGURO QUE DESEA SALIR?", "Sistema de citas médicas", 0, 0, null, botones, this);
    ...
    private javax.swing.JMenuItem jMenuCitaMedica;
